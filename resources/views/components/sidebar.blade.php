<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <li class="menu-item">
            <a href="{{ route('dashboard') }}" class="menu-link  @if(Request::is('dashboard')) active @endif">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Dashboard">Dashboard</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="{{ route('renewal') }}" class="menu-link @if(Request::is('renewal')) active @endif">
                <i class="menu-icon tf-icons bx bx-list-check"></i>
                <div data-i18n="Renewal">Renewal</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="{{ route('sessionhistory') }}" class="menu-link @if(Request::is('sessionhistory')) active @endif">
                <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
                <div data-i18n="Session History">Session History</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="{{ route('authlogs') }}" class="menu-link @if(Request::is('authlogs')) active @endif">
                <i class="menu-icon tf-icons bx bx-chart"></i>
                <div data-i18n="Authentication Logs">Authentication Logs</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="{{ route('showinvoices') }}" class="menu-link @if(Request::is('showinvoices')) active @endif">
                <i class="menu-icon tf-icons bx bx-food-menu"></i>
                <div data-i18n="Invoice">Invoice</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="{{ route('complaint') }}" class="menu-link @if(Request::is('complaint')) active @endif">
